...
function SignUp({ isSignedUp, setIsSignedUp }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const stuff = await signup({
        variables: { username: uniqueUsername, email, password },
      });
      ...
      <div className="modal" role="dialog">
        <div className="modal-box">
          ...
          <form className="max-w-sm mx-auto" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="text-white bg-green-400 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              Submit
            </button>
          </form>
